...
/**
 * see {@LevelOrderTraversalInSpiral} which is efficient than this.
 ...
 * @param <Item>
 */
public class LevelOrderTraversalInSpiral_2<Item extends Comparable<Item>> {
	...
	private LevelOrderTraversalInSpiral_2<Item>.Node insert(LevelOrderTraversalInSpiral_2<Item>.Node root2,
			Item key) {
		if (root2 == null)
			return new Node(key);
	...
	private void inOrderTraversal(LevelOrderTraversalInSpiral_2<Item>.Node root) {
		if (root == null) return;
	...
	private void printGivenLevel(LevelOrderTraversalInSpiral_2<Item>.Node x,
	...
	private int findHeight(LevelOrderTraversalInSpiral_2<Item>.Node x) {
		if(x == null)
			return -1;
	...
	public static void main(String[] args) {
		LevelOrderTraversalInSpiral_2<Integer> bt = new LevelOrderTraversalInSpiral_2<Integer>();
		bt.insert(5);
		bt.insert(3);
		bt.insert(8);
		bt.insert(1);
